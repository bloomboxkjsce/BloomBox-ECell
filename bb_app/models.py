...
class Campus(models.Model):
    ...
    image = models.ImageField(
        upload_to='images/campus-company/cc-logos', blank=True, null=True)
...
class Events(models.Model):
    ...
    eventType = models.CharField(
        max_length=20, choices=TYPE_CHOICES, default="Panel Session")
    deadline = models.DateTimeField(default=datetime.now(
    ), help_text="Please use the following format: <em>YYYY-MM-DD</em>.")
    feedbackStatus = models.CharField(max_length=13, choices=(
...
class EventImages(models.Model):
    title = models.ForeignKey(
        Events, on_delete=models.CASCADE, related_name="moreImages")
    moreImages = models.ImageField(
        upload_to=get_path_events, blank=True, null=True)


class EventRegistrations(models.Model):
    title = models.ForeignKey(
        Events, on_delete=models.CASCADE, related_name="registrations")
    name = models.CharField(max_length=100)
    email = models.EmailField()
    contact = models.CharField(max_length=50)
    college = models.CharField(
        max_length=255, default="K. J. Somaiya College of Engineering")
...
class EventRegistrationsHackathon(models.Model):
    title = models.ForeignKey(
        Events, on_delete=models.CASCADE, related_name="registrationsHackathon")
...
class Plandemic(models.Model):
    ...
    def __str__(self):
        return self.nameOfTeam + "_" + self.leaderEmail
